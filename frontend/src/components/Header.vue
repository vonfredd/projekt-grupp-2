    ...
    <nav class="p-3">
      <div class="flex items-center justify-between">
        ...
        <div class="hidden md:flex text-white">
          ...
          <div class="flex items-center justify-center bg-secondary bg-opacity-50 rounded-3xl px-2 mx-2">
            <svg fill="#000000" width="25px" height="25px" viewBox="0 0 36 36" version="1.1"
          ...
          <RouterLink v-else to="/login">
            <div class="flex items-center justify-center bg-secondary bg-opacity-50 px-5 rounded-full mx-2">
              <svg fill="#000000" width="20px" height="20px" viewBox="0 0 34 34" version="1.1"
                preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg"
                xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>user-solid</title>
                <path
      ...
      <div v-if="isMenuOpen" class="md:hidden">
        ...
        <RouterLink v-if="isLoggedIn" to="/logout">
          <div class="flex items-center justify-center bg-gray-400 bg-opacity-50 rounded-3xl px-2 mx-2">
            <svg fill="#000000" width="25px" height="25px" viewBox="0 0 36 36" version="1.1"
              preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>user-solid</title>
