        ...
        return args -> {
           ...
           bookingRepository.deleteAll();
            Booking[] bookings = new Booking[]{
                    new Booking(null, "user1", schedulesToBook.get(0), List.of(15, 2, 3,7,5,8,9)),
                    new Booking(null, "user2", schedulesToBook.get(1), List.of(4, 5,7,21,24,23,8,9,14,15,18,19,20, 6)),
                    new Booking(null, "user3", schedulesToBook.get(2), List.of(7,8,9,14,25,18,19,20)),
                    new Booking(null, "user4", schedulesToBook.get(3), List.of(7, 8, 9)),
                    new Booking(null, "user5", schedulesToBook.get(4), List.of(2, 3,7,8,9,14,15,18,19,20,21)),
                    new Booking(null, "user6", schedulesToBook.get(5), List.of(4, 5,7,8,9,14,15,18,19,20, 6)),
                    ...
                    new Booking(null, "user12", schedulesToBook.get(11), List.of(2,12, 15,11 ,17,20)),
                    new Booking(null, "user13", schedulesToBook.get(12), List.of(3, 6)),
                    new Booking(null, "user14", schedulesToBook.get(13), List.of(8, 10,23,24,26,27,11,12,15,22)),
                    new Booking(null, "user15", schedulesToBook.get(14), List.of(1, 4, 12,15 , 13, 9)),
                    new Booking(null, "user16", schedulesToBook.get(15), List.of(2, 3, 10)),
                    new Booking(null, "user17", schedulesToBook.get(16), List.of(4, 5,7,8,9,14,15,18,19,20, 6,31,32,33,35,36,24,25,26,29,30)),
                    new Booking(null, "user18", schedulesToBook.get(17), List.of(1,4,5,9,10,11,12,14,16, 7)),
                    new Booking(null, "user19", schedulesToBook.get(18), List.of(6,2,3,4,21,22,24,25, 8)),
                    new Booking(null, "user20", schedulesToBook.get(19), List.of(2, 9)),
                    new Booking(null, "user1", schedulesToBook.get(10), List.of(4, 7, 8)),
                    new Booking(null, "user2", schedulesToBook.get(3), List.of(1, 5,11,12,21,22,23,26,27)),
                    new Booking(null, "user3", schedulesToBook.get(7), List.of(6, 9,11,21,16,17,18,2)),
